...
import (
	...
	swagger_options "github.com/grpc-ecosystem/grpc-gateway/protoc-gen-beeswagger/options"
)
...
func TestApplyTemplateSimple(t *testing.T) {
	...
	fmt.Println(ObjToString(result))
	if err != nil {
...
func TestRenderMessagesAsDefinitionCs(t *testing.T) {
